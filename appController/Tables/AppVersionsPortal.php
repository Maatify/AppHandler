...
class AppVersionsPortal extends ParentClassHandler
{
    ...
    protected array $cols_to_add = [
        ...
        ['allowed', ValidatorConstantsTypes::Bool, ValidatorConstantsValidators::Require],
        ['app_id', ValidatorConstantsTypes::Int, ValidatorConstantsValidators::Require],
    ];
    ...
    protected array $cols_to_edit = [
        ...
        ['allowed', ValidatorConstantsTypes::Bool, ValidatorConstantsValidators::Optional],
        ['app_id', ValidatorConstantsTypes::Int, ValidatorConstantsValidators::Optional],
    ];
